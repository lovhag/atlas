...
#SBATCH -o /mimer/NOBACKUP/groups/snic2021-23-309/project-data/atlas/logs/pararel_eval_zero_shot_no_space_likelihood_%A_%a.out
#SBATCH -t 0-04:00:00
...
SAVE_DIR=data/experiments/pararel-eval-zero-shot-base-no-space-likelihood
