...
#SBATCH --job-name=get-atlas-base-embeddings
#SBATCH -o /mimer/NOBACKUP/groups/snic2021-23-309/project-data/atlas/logs/get_atlas_base_passage_embeddings.out
#SBATCH -t 0-10:00:00

# COMMENT: use this file to get the passage embeddings for atlas base.
...
SAVE_DIR=data/experiments/atlas-base-get-passage-embeddings
...
srun python evaluate.py \
    ...
    --save_index_path "data/saved_index/atlas-base-wiki-${YEAR}"
