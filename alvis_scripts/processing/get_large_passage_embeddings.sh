...
#SBATCH -o /mimer/NOBACKUP/groups/snic2021-23-309/project-data/atlas/logs/get_atlas_large_passage_embeddings.out
#SBATCH -t 0-10:00:00
...
SAVE_DIR=data/experiments/atlas-large-get-passage-embeddings
...
srun python evaluate.py \
    ...
    --save_index_path "data/saved_index/atlas-large-wiki-${YEAR}"
