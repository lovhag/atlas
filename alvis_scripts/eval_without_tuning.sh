...
size=base
YEAR=${1:-"2017"}
MODEL_TO_EVAL=data/models/atlas/${size} # Model not finetuned on Pararel
...
SAVE_DIR=data/experiments/no-tuning-base
EXPERIMENT_NAME=pararel-eval-${RELATION_TO_EVAL}-${SLURM_JOB_ID}
PRECISION="fp32" # "bf16"
