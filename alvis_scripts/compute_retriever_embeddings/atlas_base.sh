...
#SBATCH --job-name=compute-atlas-base-pararel-r-embeddings
#SBATCH -o /mimer/NOBACKUP/groups/snic2021-23-309/project-data/atlas/logs/pararel_r_embeddings_zero_shot_base_%A_%a.out
#SBATCH -t 0-06:00:00
...
SAVE_DIR=data/experiments/pararel-compute-r-embeddings-base
