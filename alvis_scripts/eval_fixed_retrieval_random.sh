...
#SBATCH -o /mimer/NOBACKUP/groups/snic2021-23-309/project-data/atlas/logs/pararel_eval_zero_shot_base_fixed_retrieval_random_%A_%a.out
#SBATCH -t 0-06:00:00

# COMMENT: a copy of eval_fixed_retrieval.sh using ParaRel queries with provided random fixed passages.
...
EVAL_FILES="/cephyr/users/lovhag/Alvis/projects/pararel/data/all_n1_atlas_no_space_w_retrieval_random/${RELATION_TO_EVAL}.jsonl"
PASSAGES="data/corpora/wiki/enwiki-dec${YEAR}/text-list-100-sec.jsonl data/corpora/wiki/enwiki-dec${YEAR}/infobox.jsonl"
SAVE_DIR=data/experiments/pararel-eval-zero-shot-base-fixed-retrieval-random
