...
#SBATCH -o /mimer/NOBACKUP/groups/snic2021-23-309/project-data/atlas/logs/pararel_eval_zero_shot_no_space_likelihood_no_eos_with_3_closed_book_%A_%a.out
#SBATCH -t 0-06:00:00

# COMMENT: a copy of eval.sh only for data files in which we have removed spaces preceding <extra_id_0> in the files. And evaluate the model closed-book.
...
SAVE_DIR=data/experiments/pararel-eval-zero-shot-base-no-space-likelihood-no-eos-with-3-closed-book
