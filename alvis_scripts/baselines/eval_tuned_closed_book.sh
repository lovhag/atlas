...
EVAL_RELATIONS=("P937" "P1412" "P103" "P276" "P159" "P140" "P136" "P495" "P17" "P361" "P36" "P740" "P264" "P407" "P30" "P131" "P176" "P279" "P19" "P101" "P364" "P106" "P1376" "P178" "P413" "P27" "P20" "P449")
RELATION_TO_EVAL=${EVAL_RELATIONS[$SLURM_ARRAY_TASK_ID]}

size=base
YEAR=${1:-"2017"}
MODEL_TO_EVAL='data/experiments/pararel_training_hyperparam_search/12-987333/checkpoint/step-100' # Model finetuned on Pararel
...
SAVE_DIR=data/experiments/hyperparam-tuned-closed-book
