...
#SBATCH --job-name=train-t5-baseline-pararel
#SBATCH -o /mimer/NOBACKUP/groups/snic2021-23-309/project-data/atlas/logs/pararel_train_baseline_t5.out
#SBATCH -t 0-04:00:00

# COMMENT: this is largely a copy of the tuned Atlas 12 run
...
EXPERIMENT_NAME=12-${SLURM_JOB_ID}

port=$(shuf -i 15000-16000 -n 1)
TRAIN_FILES="/cephyr/users/lovhag/Alvis/projects/pararel/data/all_n1_atlas/P138.jsonl /cephyr/users/lovhag/Alvis/projects/pararel/data/all_n1_atlas/P127.jsonl"
...
SAVE_DIR=data/experiments/pararel_train_baseline_t5/
PRECISION="fp32" # "bf16"
...
srun python train.py \
    ...
    --temperature_gold 0.01 --temperature_score 0.1 \
    --refresh_index -1 \
    --target_maxlength 16 \
    --reader_model_type google/t5-${size}-lm-adapt \
    --dropout 0.1 \
    --lr 5e-05 --lr_retriever 1e-05 \
    --scheduler linear \
    --weight_decay 0.01 \
    --text_maxlength 512 \
