...
#SBATCH --job-name=train-atlas-pararel-hyperparam-search-13
#SBATCH -o /mimer/NOBACKUP/groups/snic2021-23-309/project-data/atlas/logs/pararel_train_hyperparam_search_13.out
#SBATCH -t 0-04:00:00
...
EXPERIMENT_NAME=13-${SLURM_JOB_ID}
