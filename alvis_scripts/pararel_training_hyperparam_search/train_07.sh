...
#SBATCH --job-name=train-atlas-pararel-hyperparam-search-07
#SBATCH -o /mimer/NOBACKUP/groups/snic2021-23-309/project-data/atlas/logs/pararel_train_hyperparam_search_07.out
#SBATCH -t 0-04:00:00
...
EXPERIMENT_NAME=07-${SLURM_JOB_ID}

port=$(shuf -i 15000-16000 -n 1)
TRAIN_FILES="/cephyr/users/lovhag/Alvis/projects/pararel/data/all_n1_atlas/P138.jsonl /cephyr/users/lovhag/Alvis/projects/pararel/data/all_n1_atlas/P127.jsonl /cephyr/users/lovhag/Alvis/projects/pararel/data/all_n1_atlas/P1412.jsonl"
