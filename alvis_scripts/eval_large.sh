...
#SBATCH -o /mimer/NOBACKUP/groups/snic2021-23-309/project-data/atlas/logs/pararel_eval_zero_shot_large_%A_%a.out
#SBATCH -t 0-06:00:00

# COMMENT: a copy of eval_no_space.sh using Atlas-large instead of base.
...
SAVE_DIR=data/experiments/pararel-eval-zero-shot-large
...
srun python evaluate.py \
    ...
    --load_index_path data/saved_index/atlas-large-wiki-2017 \
    --use_decoder_choices \
